			  ...
			  <div class="column">
		    	<div class="control">
					<label>Referencia</label>
				  	<input class="input" type="text" name="referencia" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required value="<?php echo $datos['referencia']; ?>" >
				</div>
		  	</div>
		</div>
		<div class="columns">
